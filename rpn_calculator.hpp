...
private:
    ...
    {
        //If char on top stack is an operator, create and return operator object
        switch(operation)
        {
    ...
    //Pops operator and two numbers from stack and performs calculation
...
public:
    //Reads string from input and converts and adds to stack
